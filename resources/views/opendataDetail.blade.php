...
<div class="ui container">
  <div class="ui grid">
    <div class="two column row">
      <div class="left floated column"><h5 class="ui header" style="margin-top:10px"><a href="{{route('opendata.data')}}"><i class="home icon"></i>Opendata Detail</a><span> / {{$pemda['nama_pemda']}}</span></h5></div>
    </div>
  </div>
